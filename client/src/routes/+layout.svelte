<script>
    ...
    export let data
    let { user } = data
    console.log(user, 'parent layout')
...
<svelte:head>
    {#if $page.url.pathname === '/'}
        <title>Home</title>
    {:else if $page.url.pathname === '/books'}
        <title>Books</title>
    {:else if $page.url.pathname === '/cart'}
        <title>Cart</title>
...
<header class="header font-Mulish">
    <div class="header-container items-center">
        <div class="flex items-center justify-between">
            <a class="header__logo--img fa-bounce mr-2" href="/">
                <svg
                    data-v-6805eed4=""
                    version="1.0"
            ...
            <a
                href="/books"
                class="no-underline text-sm border-none hover:rounded-sm hover:bg-slate-500 shadow-none text-[#134f5c] hover:text-white bg-transparent btn h-6 min-h-0 px-6"
            >
                Categories
            </a>
        </div>
        ...
        <ul class="header__links">
            <li class="">
                <a
                    href="/cart"
                    class="no-underline text-sm border-none hover:rounded-sm hover:bg-slate-500 shadow-none text-[#134f5c] hover:text-white bg-transparent btn h-6 px-1 pt-1 pb-1 min-h-0"
                >
                    <FaShoppingCart />
                </a>
            </li>
            {#if user !== null && user !== undefined}
                <li class=" ">
                    <a
                        href="/profile"
                        class="no-underline text-sm border-none hover:rounded-sm hover:bg-white shadow-none text-[#134f5c] hover:text-green-300 bg-transparent btn h-4 min-h-0 px-6"
                    >
                        <FaUserAlt />
                        <!-- {user.data.user.name} -->
                    </a>
    ...
    <div class="header-container">
        <div class="row">
            <div class="footer-col">
                <a class="footer__logo--img fa-bounce" href="/">
                    <svg
                        data-v-6805eed4=""
                        version="1.0"
                        xmlns="http://www.w3.org/2000/svg"
